...
#' @aliases cnd-cnd-conditions cnd:as_character_cnd_error cnd:cnd_generated_cleanup cnd:cnd_generated_write cnd:cond_cnd_class cnd:condition_overwrite cnd:conditions_dots cnd:invalid_condition cnd:invalid_condition_message cnd:match_arg cnd:no_package_exports as_character_cnd_error cnd_generated_cleanup cnd_generated_write cond_cnd_class condition_overwrite conditions_dots invalid_condition invalid_condition_message match_arg no_package_exports cnd:as_character_cnd_error/error cnd:cnd_generated_cleanup/condition cnd:cnd_generated_write/condition cnd:cond_cnd_class/error cnd:condition_overwrite/warning cnd:conditions_dots/warning cnd:invalid_condition/error cnd:invalid_condition_message/error cnd:match_arg/error cnd:no_package_exports/warning
...
#'
#' 
#'   \subsection{`cnd:cnd_generated_cleanup/condition`}{
#'   \describe{
#'     \item{package}{`{cnd}`}
