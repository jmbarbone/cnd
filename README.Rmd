...
`condition()` creates a `cnd::condition_function` that can generate the condition when called.
...
`cnd::condition_function`s can also take parameters that are used in creating a custom message.
